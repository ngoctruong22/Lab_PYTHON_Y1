...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "integrate_4",
        "sources": [
            "F:\\Lab10\\Integrate\\cython\\integrate_4.pyx"
        ]
    },
    "module_name": "integrate_4"
}
END: Cython Metadata */
...
#define __PYX_HAVE__integrate_4
#define __PYX_HAVE_API__integrate_4
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "integrate_4" */
static double __pyx_f_11integrate_4_integrate_cy(double, double, int, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE double __pyx_f_11integrate_4__integrate_cy_nogil(double, double, int); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "integrate_4"
extern int __pyx_module_is_main_integrate_4;
int __pyx_module_is_main_integrate_4 = 0;

/* Implementation of "integrate_4" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_11integrate_4_integrate_cy(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_kp_u_integrate_4_pyx __pyx_string_tab[1]
#define __pyx_kp_u_n_iter_must_be_positive __pyx_string_tab[2]
...
#define __pyx_n_u_integrate_4 __pyx_string_tab[9]
...
#define __pyx_kp_b_iso88591_wc_j_as_Q __pyx_string_tab[23]
...
static PyObject *__pyx_pw_11integrate_4_1integrate_cy(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static double __pyx_f_11integrate_4_integrate_cy(double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_r;
...
*/
    ...
    __pyx_t_4 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_mstate_global->__pyx_kp_u_n_iter_must_be_positive};
 ...
 * 
*/
  __pyx_t_5 = __pyx_f_11integrate_4__integrate_cy_nogil(__pyx_v_a, __pyx_v_b, __pyx_v_n_iter); if (unlikely(__pyx_t_5 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
  __pyx_r = __pyx_t_5;
  goto __pyx_L0;
...
*/
  ...
  __Pyx_AddTraceback("integrate_4.integrate_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
PyDoc_STRVAR(__pyx_doc_11integrate_4_integrate_cy, "\320\222\321\213\321\207\320\270\321\201\320\273\321\217\320\265\321\202 \320\277\321\200\320\270\320\261\320\273\320\270\320\266\321\221\320\275\320\275\321\213\320\271 \320\270\320\275\321\202\320\265\320\263\321\200\320\260\320\273 \321\204\321\203\320\275\320\272\321\206\320\270\320\270 sin(x) \320\275\320\260 \320\276\321\202\321\200\320\265\320\267\320\272\320\265 [a, b]\n    \320\274\320\265\321\202\320\276\320\264\320\276\320\274 \320\273\320\265\320\262\321\213\321\205 \320\277\321\200\321\217\320\274\320\276\321\203\320\263\320\276\320\273\321\214\320\275\320\270\320\272\320\276\320\262 \321\201 n_iter \321\200\320\260\320\267\320\261\320\270\320\265\320\275\320\270\321\217\320\274\320\270.\n\n    \320\222\320\276\320\267\320\262\321\200\320\260\321\211\320\260\320\265\321\202 double.\n    ");
static PyMethodDef __pyx_mdef_11integrate_4_1integrate_cy = {"integrate_cy", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_11integrate_4_1integrate_cy, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_11integrate_4_integrate_cy};
static PyObject *__pyx_pw_11integrate_4_1integrate_cy(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_cy", 0) < (0)) __PYX_ERR(0, 7, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_cy", 1, 3, 3, i); __PYX_ERR(0, 7, __pyx_L3_error) }
      }
    ...
    __pyx_v_n_iter = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("integrate_cy", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_11integrate_4_integrate_cy(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_11integrate_4_integrate_cy(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  ...
  __pyx_t_1 = __pyx_f_11integrate_4_integrate_cy(__pyx_v_a, __pyx_v_b, __pyx_v_n_iter, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L1_error)
...
static CYTHON_INLINE double __pyx_f_11integrate_4__integrate_cy_nogil(double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  double __pyx_v_acc;
  double __pyx_v_step;
  int __pyx_v_i;
  double __pyx_v_x;
...
static int __pyx_pymod_exec_integrate_4(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_integrate_4},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_integrate_4(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_integrate_4(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_integrate_4(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'integrate_4' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "integrate_4" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_integrate_4", 0);
  ...
  if (__pyx_module_is_main_integrate_4) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "integrate_4")) {
      if (unlikely((PyDict_SetItemString(modules, "integrate_4", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * @cython.cdivision(True)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_11integrate_4_1integrate_cy, 0, __pyx_mstate_global->__pyx_n_u_integrate_cy, NULL, __pyx_mstate_global->__pyx_n_u_integrate_4, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate_cy, __pyx_t_2) < (0)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init integrate_4", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init integrate_4");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{15},{23},{20},{1},{18},{1},{18},{8},{11},{12},{13},{5},{8},{10},{6},{8},{3},{12},{12},{10},{8},{6},{41}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (216 bytes) */
const char* const cstring = "x\332MN=K\003Q\020L@%\220 \244U\220\003\373T\366i\254E\375\003\303\336\313F\236\276\217\363v_\274\353R\246\264\2742?\311\322\322\237\220\237\340BD]\330\235\031\226\335\231\245O\312O-)\343f\321\364]\202Wn\253XD\253\232\253&\213W\277a\340\276\357\254o\275S\334q\247\217\274&\222>9\237\027.\267\271\250O,\265\013\006\360\t\332\222\343\232\334\013\260.\311\001\377|\376\250\353\341\005\277\367f\035\005\210d\017\254b^\225`\326\307L\206\024M5\271\001^\013\205\243\004\204\365gele\271JP@Yln(\024\226\355\370p6\272\270<\314F\247\223\355\333\316\275\317?'\347\273\347a<\314\277N\246\037\323\253\201\006\331_\357\037\276\001\250Ai\360";
...
const char* const bytes = "?integrate_4.pyxn_iter must be positive__Pyx_PyDict_NextRefaasyncio.coroutinesbcline_in_traceback__func__integrate_4integrate_cy_is_coroutineitems__main____module__n_iter__name__pop__qualname____set_name__setdefault__test__values\200\001\360\006\000\032\033\360\014\000\005\010\200w\210c\220\021\330\010\016\210j\230\001\230\021\340\004\013\320\013\036\230a\230s\240#\240Q";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_integrate_4_pyx, __pyx_mstate->__pyx_n_u_integrate_cy, __pyx_mstate->__pyx_kp_b_iso88591_wc_j_as_Q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
